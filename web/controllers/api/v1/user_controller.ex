defmodule Brainhub.UserController do
  ...
  def index(conn, _params, _user) do
    users = Brainhub.Company.employees(conn.assigns.current_company_id)
  ...
  def show(conn, %{"id" => id}, _user) do
    if Brainhub.Company.employer?(conn.assigns.current_company_id, id) do
